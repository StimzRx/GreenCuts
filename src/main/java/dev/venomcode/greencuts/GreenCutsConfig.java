...
public class GreenCutsConfig
{
    ...
    public GreenCutsConfig()
    {
        loader = HoconConfigurationLoader.builder()
                .path(Path.of("./config/" + GreenCuts.MODID + ".conf"))
                .build();
        try
        {
        ...
        {
            GreenCuts.debugLog("Error occurred loading config:" + ex.getMessage());
            if(ex.getCause() != null)
            {
    ...
    private boolean save()
    {
        ...
        {
            GreenCuts.debugLog("Unable to save config for '" + GreenCuts.MODID + "'! Error: " + ex.getMessage());
        }
        return false;
    }
